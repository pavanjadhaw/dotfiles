...
change_color() {
	# polybar
	sed -i -e 's/background = #.*/background = #0F0F0F/g' $PFILE
	sed -i -e 's/background-alt = #.*/background-alt = #161616/g' $PFILE
	sed -i -e 's/foreground = #.*/foreground = #F0F0F0/g' $PFILE
	sed -i -e 's/foreground-alt = #.*/foreground-alt = #E7E7E7/g' $PFILE
